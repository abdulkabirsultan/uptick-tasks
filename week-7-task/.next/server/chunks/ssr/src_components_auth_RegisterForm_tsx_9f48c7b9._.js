...
function RegisterForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (password !== confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Passwords don't match");
            setLoading(false);
            return;
        }
        if (password.length < 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Password must be at least 6 characters long');
            setLoading(false);
            return;
        }
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Registration failed');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=src_components_auth_RegisterForm_tsx_9f48c7b9._.js.map